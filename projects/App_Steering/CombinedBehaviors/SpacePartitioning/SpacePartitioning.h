...
public:
	...
	void RegisterNeighbors(SteeringAgent* pAgent, SteeringAgent* pFirstAgent, float queryRadius);
	const std::vector<SteeringAgent*>& GetNeighbors() const { return m_pNeighbors; }
	int GetNrOfNeighbors() const { return m_NrOfNeighbors; }

	void RenderCells(SteeringAgent* pFirstAgent, float queryRadius)const;
...
private:
	...
	// Debug
	std::vector<int> m_OverlappedCellsIdx;
